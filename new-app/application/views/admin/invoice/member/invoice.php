            ...
            <div class="row">
                <div class="col-xl-4">
                    <div class="card widget widget-stats">
                        <a href="<?php echo base_url('admin/invoice/member/prevmonth') ?>" style="text-decoration: none;">
                ...
                <div class="col-xl-4">
                    <div class="card widget widget-stats">
                        <a href="<?php echo base_url('admin/invoice/member/thismonth') ?>" style="text-decoration: none;">
                ...
                <div class="col-xl-4">
                    <div class="card widget widget-stats">
                        <a href="<?php echo base_url('admin/invoice/member/allinvoice') ?>" style="text-decoration: none;">
