                    ...
                    <div class="card position-relative">
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <form class="form-horizontal" action="<?php echo base_url('admin/router/hotspot/prosesgenerate'); ?>" role="form" method="POST">
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" autocomplete="off" name="comment" id="comment">
                                </div>
                            </div>
