                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><a href="<?= base_url("hotspot/deleteactive/" . $id) ?>" onclick="return confirm('Apakah anda yakin ingin menghapus user <?= $data['user']; ?> ?')" class="btn btn-sm btn-danger"><i class='material-icons-outlined'>delete</i><strong>Delete</strong></a>
                                                            </td>
                                                            <td><?= $data['server'] ?></td>
                                                            <td><?= $data['user'] ?></td>
