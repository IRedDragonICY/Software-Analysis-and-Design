    ...
    foreach ($comment as $data) {
        ...
        foreach ($service as $dataserv) {
            ...
            foreach ($router as $datarouter) {
                ...
                $url = urlencode('http://' . $dns . '/login?username' . $data->kode . '&password=' . $data->kode);

                $timelimit = $dataserv->uptime;
                $getsprice = $dataserv->harga;
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="width:75px">
                                                ...
                                                <img style="margin:5px 0 0 5px;" width="85" height="40" src="<?= base_url() ?>assets/logo/<?= $logo ?>" alt="logo">
                                        ...
                                        <tr>
                                            <td style="width:95px" valign="top">
                                                <div style="clear:both;color:#555;margin-top:2px;margin-bottom:2.5px;">
                                                    ...
                                                    <div style="padding:0px;border-bottom:1px solid<?php echo $color ?>;text-align:center;font-weight:bold;font-size:14px;;color:#000000;"><?= $data->kode ?></div>
                                                </div>
                                                <div style="text-align:center;color:#111;font-size:7px;font-weight:bold;margin:0px;padding:2.5px;">
                                                    Hubungkan ke wifi fiber delta hotspot
                                                </div>
                                            </td>
