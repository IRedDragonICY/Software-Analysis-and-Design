    ...
    <div class="row p-2 m-1 rounded bg-light mob1 shadow-lg">
        <div class="d-flex justify-content-between mb-2">
            ...
            <div class="text-right" style="margin-top: auto;margin-bottom: auto;">
                <img src="<?= $payment[0]->icon_url ?> " style="height:100%;max-height:30px;" />
            </div>
        </div>
        ...
        <div class="col-md-7 col-lg-12 mt-2">
            <ul class="list-group mb-3">
                <li class="list-group-item">
                    ...
                    <small class="text-muted"><?= $tripay->merchant_ref ?></small>
                </li>
                <?php if (str_contains($tripay->payment_name, 'QRIS') && ($tripay->status == 'UNPAID')) { ?>
                    <li class="list-group-item">
                        <div>
                            <h6 class="my-0">Kode QRIS <small class="fw-normal">(*Klik untuk memperbesar kode QR)</small>
                            </h6>
                            <div class="mt-1 w-100 d-flex justify-content-center">
                                <img onclick='zoomQR()' src="<?= $tripay->qr_url ?>" width="175px" height="175px" />
                            </div>
                    ...
                    <li class="list-group-item">
                        <div>
                            ...
                            <div class="input-group mt-1 w-100">
                                <input type="text" class="form-control" id="kodebayar" value="<?= $tripay->pay_code ?>">
                ...
                <li class="list-group-item d-flex justify-content-between lh-sm">
                    ...
                    <div>
                        <small>Rp <?= number_format($tripay->fee_customer, 0, ',', '.') ?></small>
                        <h6>Rp <?= number_format($tripay->amount, 0, ',', '.') ?></h6>
                    </div>
                </li>
                ...
                <li class="list-group-item d-flex justify-content-between">
                    ...
                    <div>
                        <strong>
                            ...
                            } else if ($tripay->status == 'PAID') {
                                echo '<small class="text-success">Lunas</small>';
                            } else if ($tripay->status == 'EXPIRED') {
                ...
                <?php if ($tripay->status == 'UNPAID') { ?>
                    <li class="list-group-item d-flex justify-content-between">
                        <h6 class="my-0">Batas Pembayaran</h6>
                        <span class="text-danger"><strong><?= tanggal_indo(date("Y-m-d", $tripay->expired_time)) . ' ' . date("H:i", $tripay->expired_time) ?>
                                WIB</strong></span>
                    </li>
                <?php } ?>
            </ul>
        ...
        <div class="d-flex justify-content-center">
            <a href="<?= base_url() ?>member/history/topup" class="btn btn-success btn-sm me-2" type="button">
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding:0 !important;">
                <?php foreach ($tripay->instructions as $row) { ?>
