                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="tm_width_6 tm_accent_border_20">
                                                <b class="tm_primary_color tm_medium">Email : </b><?= $cetak->idpel ?>
                                            </td>
                                            <td class="tm_width_6 tm_border_left tm_accent_border_20">
                                                <b class="tm_primary_color tm_medium">Invoice Date : </b> <?= tgl_indo($cetak->date)  ?>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <table>
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="tm_width_4 tm_semi_bold tm_accent_color tm_accent_bg_10">Invoice Date</th>
                                            <th class="tm_width_2 tm_semi_bold tm_accent_color tm_accent_bg_10">Jumlah diterima</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="tm_width_4 tm_accent_border_20"><?= tgl_indo($cetak->date)   ?></td>
                                            <td class="tm_width_2 tm_accent_border_20">Rp <?= number_format($cetak->price) ?></td>
                                            <td class="tm_width_2 tm_accent_border_20 tm_text_right">Rp <?= number_format($cetak->price) ?></td>
                                        </tr>
                                ...
                                <table class="tm_mb15 tm_m0_md">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="tm_width_3 tm_primary_color tm_text_right tm_border_none tm_medium">Rp <?= number_format($cetak->price) ?></td>
                                        </tr>
