<?php $this->load->view('templates/member/invoice/header'); ?>
    ...
    <div class="row p-2 m-1 rounded bg-light mob1 shadow-lg">
        ...
        <div class="col-md-7 col-lg-12 mt-2">
            <ul class="list-group mb-3">
                ...
                <?php if (str_contains($tripay->data->payment_name, 'QRIS') && ($tripay->data->status == 'UNPAID')) { ?>
                    <li class="list-group-item">
                        <div>
        ...
        <div class="d-flex justify-content-center">
            <a href="<?= base_url() ?>member/topup" class="btn btn-success btn-sm me-2" type="button">
...
<?php $this->load->view('templates/member/invoice/footer'); ?>